...
// // function createIconTexture(gl, IconComponent, iconColor = '#61dafb', size = 128) {
...
// //         <div xmlns="http://www.w3.org/1999/xhtml" style="width: 24px; height: 24px; color: ${iconColor};">
...
// //   // Create a more direct approach - draw the icon path directly
// //   context.fillStyle = iconColor;
// //   context.fillRect(0, 0, canvas.width, canvas.height);
  
// //   // Create a simpler approach - use CSS-style icon rendering
// //   drawIcon(context, IconComponent, iconColor, size);
...
// // function drawIcon(context, IconComponent, color, size) {
// //   // Clear canvas with transparent background
// //   context.clearRect(0, 0, size, size);
  
// //   // Create a gradient background
// //   const gradient = context.createRadialGradient(size/2, size/2, 0, size/2, size/2, size/2);
// //   gradient.addColorStop(0, color + '40'); // Semi-transparent center
// //   gradient.addColorStop(1, color + '10'); // More transparent edges
  
// //   // Fill background with gradient
// //   context.fillStyle = gradient;
// //   context.fillRect(0, 0, size, size);
  
// //   // Draw icon representation (simplified geometric shapes based on common icon patterns)
...
// //   // Draw a generic tech icon shape (can be customized per icon type)
// //   context.beginPath();
// //   context.roundRect(centerX - iconSize/2, centerY - iconSize/2, iconSize, iconSize, iconSize/8);
// //   context.fill();
  
// //   // Add some detail lines to make it look more like a tech icon
// //   context.strokeStyle = 'rgba(255, 255, 255, 0.3)';
// //   context.lineWidth = 2;
// //   context.beginPath();
// //   context.moveTo(centerX - iconSize/4, centerY - iconSize/4);
// //   context.lineTo(centerX + iconSize/4, centerY + iconSize/4);
// //   context.moveTo(centerX + iconSize/4, centerY - iconSize/4);
// //   context.lineTo(centerX - iconSize/4, centerY + iconSize/4);
// //   context.stroke();
// // }
...
// //   // you'd want to extract the actual SVG path from the icon
// //   return '<rect width="20" height="20" x="2" y="2" rx="2" fill="currentColor"/>';
// // }
...
// //   createShader() {
// //     const { texture } = createIconTexture(this.gl, this.icon, this.iconColor, 256);
...
// //     const skillItems = skills && skills.length ? skills : defaultSkills;
